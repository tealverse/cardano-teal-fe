...
type CardanoLogoProps = {
  size: number;
};

export const CardanoLogo = (props: CardanoLogoProps) => {
  return (
    <Container {...props}>
      <svg version="1.1" x="0px" y="0px" viewBox="0 0 375 346.5">
        <Path
...
const Container = styled.div(({ size }: ContainerProps) => [
  css`
    height: ${size}rem;
    width: ${size}rem;
  `,
